...
def main():
    ...
    input1 = "ba"
    output1 = trie.search_word(input1)
    print(f"Input: {input1}")
    print(f"Output: {output1}")
    print()

    input2 = "bi"
    output2 = trie.search_word(input2)
    print(f"Input: {input2}")
    print(f"Output: {output2}")
    print()

    input3 = "fre"
    output3 = trie.search_word(input3)
    print(f"Input: {input3}")
    print(f"Output: {output3}")
    print()

    input4 = "freed"
    output4 = trie.search_word(input4)
    print(f"Input: {input4}")
    print(f"Output: {output4}")
    print()

    input5 = "ze"
    output5 = trie.search_word(input5)
